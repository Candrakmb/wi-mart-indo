<div class="col text-right" style="margin: 0 -3em 0 0;">
    <a href="/add_bank/create" type="button" class="btn btn-primary btn-data" id="btn-create" style="margin: 1em 0 0 0;">
        ...
        <div class="row">
            ...
            <div class="btn dropdown" >
                ...
                <div class="dropdown-menu">
                    <label class="dropdown-item"><input class="toggle-vis" data-column="2" type="checkbox" checked> Bank </label>
                    <label class="dropdown-item"><input class="toggle-vis" data-column="3" type="checkbox" checked> Pemilik </label>
                    <label class="dropdown-item"><input class="toggle-vis" data-column="4" type="checkbox" checked> Nomer Rekening </label>
                </div>
            </div>
        </div>
        </div>
        ...
        <table id="table" class="table stripe" style="width: 100%;">
            <thead>
                <tr class="tr-table">
                    ...
                    <th class="th-table" style="font-size: 12px;">Bank</th>
                    <th class="th-table" style="font-size: 12px;">Pemilik</th>
                    <th class="th-table" style="font-size: 12px;">Nomer Rekening</th>
                </tr>
            </thead>
